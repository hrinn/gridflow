...
//        fullScreen();
    ...
    public static void main(String[] args) {
        ...
        OldMain mainSketch = new OldMain();
//        cp5 = new ControlP5(mainSketch);
    ...
    public static void readComponentFile(OldMain mainSketch, String fileName) throws IOException {
    ...
    public static void buildComponent(OldMain mainSketch, String[] values) {
    ...
    public static void buildGridPowerSource(OldMain mainSketch, String[] values) {
    ...
    public static void buildSubstation(OldMain mainSketch, String[] values) {
    ...
    public static void buildAssignment(OldMain mainSketch, String[] values) {
    ...
    public static void buildAssociation(OldMain mainSketch, String[] values) {
    ...
    public static void buildClone12kVB(OldMain mainSketch, String[] values) {
    ...
    public static void buildTandemBreakers(OldMain mainSketch, String[] values) {
    ...
    public static void buildTwoNode(OldMain mainSketch, String[] values) {
    ...
    public static void buildOneNode(OldMain mainSketch, String[] values) {
    ...
    public static void buildZeroNode(OldMain mainSketch, String[] values) {
    ...
    public static void buildConnectedLoad(OldMain mainSketch, String[] values) {
    ...
    public static void testRun(OldMain mainSketch) {
    ...
    public static void setInitialEnergyState(OldMain mainSketch) {
